...
const UspSection = () => {
    return (
        <section className='max-w-[110rem] w-[95%] bg-[#2E5077] my-5 py-12 px-12 mx-auto rounded-xl grid grid-cols-3'>
            <div className='flex flex-col items-center'>
                ...
                <h4 className='text-xl font-medium text-[#fff] mt-4 mb-2'>Secure Payment</h4>
                <p className='text-[#c8c8c8]'>100% Secure Payment Guarantee</p>
            </div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h4 className='text-xl font-medium text-[#fff] mt-4 mb-2'>24/7 Support</h4>
                <p className='text-[#c8c8c8]'>Dedicated support</p>
            </div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h4 className='text-xl font-medium text-[#fff] mt-4 mb-2'>Free Hosting</h4>
                <p className='text-[#c8c8c8]'>Free hosting + domain</p>
            </div>
        </section>
    )
}
