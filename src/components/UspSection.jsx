...
const UspSection = () => {
    return (
        <>
            <section className='bg-d-blue main-section mt-10 py-12 px-12 mx-auto rounded-xl grid lg:grid-cols-3 lg:gap-0 md:gap-0 gap-5'>
                <div className='flex flex-col items-center'>
                    ...
                    <h4 className='text-xl font-medium tx-white mt-4 mb-2'>Secure Payment</h4>
                    <p className='tx-gray text-center'>100% Secure Payment Guarantee</p>
                </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <h4 className='text-xl font-medium tx-white mt-4 mb-2'>24/7 Support</h4>
                    <p className='tx-gray text-center'>Dedicated support</p>
                </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <h4 className='text-xl font-medium tx-white mt-4 mb-2'>Free Hosting</h4>
                    <p className='tx-gray text-center'>Free hosting + domain</p>
                </div>
            </section>
        </>
    )
