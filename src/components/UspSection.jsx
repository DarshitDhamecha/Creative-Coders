...
const UspSection = () => {
    return (
        <>
            <section className='bg-d-blue main-section mt-10 py-12 px-12 mx-auto rounded-xl grid grid-cols-3'>
                <div className='flex flex-col items-center'>
                    ...
                    <p className='tx-gray'>100% Secure Payment Guarantee</p>
                </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <p className='tx-gray'>Dedicated support</p>
                </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <p className='tx-gray'>Free hosting + domain</p>
                </div>
            </section>
        </>
    )
